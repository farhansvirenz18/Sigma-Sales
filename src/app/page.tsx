      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <p className="text-sm text-gray-500">Gagal / Dibatalkan</p>
              <p className="text-xl font-bold text-gray-900">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                {stats.monthlyProcessing.map((item) => (
                  <div key={item.month} className="flex items-center space-x-3">
                    ...
                    <div className="flex-1 h-6 bg-gray-100 rounded-full overflow-hidden">
                      <div
                        className="h-full bg-gradient-primary rounded-full transition-all duration-700 ease-out flex items-center justify-end pr-2"
                        style={{
                          width: `${Math.max((item.total / maxMonthly) * 100, 8)}%`,
                        }}
                      >
        ...
        <Card>
          <CardHeader>
            ...
            <p className="text-sm text-gray-500">Distribusi data per sumber</p>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-2">
              <Link
                href="/upload"
                className="flex items-center space-x-4 p-3 rounded-xl hover:bg-blue-50 transition-colors group"
              >
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-500">5 sesi terbaru</p>
              </div>
              <Link
                href="/history"
