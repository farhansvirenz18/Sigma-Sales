    ...
    <div className="space-y-5 sm:space-y-6">
      ...
      {activeTab === "overview" && (
        <div className="space-y-5 sm:space-y-6 animate-fade-in">
          ...
          {session.new_products && session.new_products.length > 0 && (
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h3 className="text-sm font-semibold text-amber-800">
                    {session.new_products.length} ProductCode baru otomatis didaftarkan
                  </h3>
                  <p className="text-sm text-amber-700 mt-1">
                    Kode: {session.new_products.join(", ")}
                  </p>
                  <p className="text-xs text-amber-600 mt-2">
                    Silakan edit nama produk dan HPP di halaman Product Management.
                  </p>
                </div>
              </div>
            </div>
